 ...
 * Si prefieres no subir el archivo 'firebase-applet-config.json' a GitHub,
 * puedes usar variables de entorno (VITE_FIREBASE_...) y reemplazar el objeto
 * 'firebaseConfig' por uno que lea de 'import.meta.env'.
 */

// Firebase configuration
// Prioritize environment variables (useful for Vercel/Production)
// Fall back to the JSON file if environment variables are not set
